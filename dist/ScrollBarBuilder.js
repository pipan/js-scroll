...
var ScrollBarBuilder = (function () {
    ...
    ScrollBarBuilder = __decorate([
        ...
        __param(0, inversify_1.inject(common_1.DomService)), __param(1, inversify_1.inject('ComponentBuilder')), __param(1, inversify_1.named('scroll-mark')), __param(2, inversify_1.inject(common_1.EmitterService)),
